...
public class TestEmployee {
    public static void main(String[] args) {
        ...
        Employee employee = new Employee (1118, "ELSA BROSON", "Av 5a","310", employeeType);
//        dbe.insert(employee);
        
        //modificar
        employee.setFullname("Xavi Hernández");
...
//                            " address: " + employee2.getAddress() + " phone: " + employee2.getPhone() + 
